...
export function CookieConsentBanner() {
  ...
  return <aside className="eos-cookie-banner fixed inset-x-3 bottom-3 z-[120] mx-auto max-w-3xl rounded-2xl border border-[#eaded6] bg-white p-4 shadow-[0_18px_60px_rgba(47,29,20,0.2)] sm:inset-x-auto sm:right-6 sm:bottom-6 sm:left-6 sm:p-5" aria-label="Cookie consent" role="dialog">
