...
export function UpscalePanel({ tutorialButton, sourceImage, workspaceId, imageUploadConstraints, onSourceImageChange, onSourceImageClear, onPendingImageChange }: UpscalePanelProps) {
  const { t } = useLocale();
