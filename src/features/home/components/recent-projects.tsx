...
export function RecentProjects() {
  ...
  return <section>
    <div className="mb-3 flex items-center justify-between gap-4"><h2 className="text-lg font-black tracking-tight">Recent projects</h2><Link href="/projects" className="inline-flex touch:min-h-10 shrink-0 items-center gap-1 text-xs font-bold text-primary hover:text-[#c85427]">View all projects <ArrowRight size={13} /></Link></div>
