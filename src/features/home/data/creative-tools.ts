...
export const creativeTools: CreativeTool[] = [
  ...
  { name: "AI Presenter", description: "AI presenters that represent you", href: "/create/ai-presenter", icon: UserRound, imageSrc: "/generated-icons-v2/icon-3-profile.png", accent: "green", comingSoon: true },
  ...
  { name: "Document", description: "Smart docs with AI & OCR", href: "/create/document", icon: FileText, imageSrc: "/generated-icons-v2/icon-5-document.png", accent: "blue", comingSoon: true },
  { name: "Custom", description: "Build custom AI workflows", href: "/create/workflow", icon: Sparkles, imageSrc: "/generated-icons-v2/icon-6-custom-v2.png", accent: "yellow", comingSoon: true },
];
